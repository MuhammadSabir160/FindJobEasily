                  ...
                  new Align(
                    ...
                    child: new Padding(
                      ...
                      child: new Column(
                        ...
                        children: <Widget>[
                          new CircleAvatar(
                            backgroundImage: new AssetImage('images/photo.jpg'),
                            radius: _height / 10,
                          ),
                          new SizedBox(
                            height: _height / 30,
                          ...
                          child: new Column(
                            children: <Widget>[
                              infoChild(_width, Icons.email,
                                  'muhammadsabir.1601139@gmail.com'),
                              infoChild(_width, Icons.call, '+92 3022079971'),
                              infoChild(_width, Icons.chat_bubble, 'Show CV'),
                              new Padding(
